Webruntime.define('lwc/item', ['lwc', 'lightning/configProvider', '@salesforce/user/Id', 'wire-service', 'instrumentation/service', 'aura-storage', 'aura'], function (lwc, configProvider, UserId, wireService, service, auraStorage, aura) { 'use strict';

    UserId = UserId && Object.prototype.hasOwnProperty.call(UserId, 'default') ? UserId['default'] : UserId;
    ...
    **/
    ...
    function tmpl$6($api, $cmp, $slotset, $ctx) {
      ...
      return [api_custom_element("lightning-card", _lightningCard, {
        ...
        classMap: {
          ...
          "slds-m-left_large": true
        },
        key: 0
      }, [api_dynamic($cmp.item.invmgrnp__Display_Name__c)])]), api_element("div", {
        classMap: {
          "slds-col": true,
          "slds-size_1-of-1": true,
          "slds-medium-size_2-of-12": true,
          "slds-large-size_2-of-12": true
        },
        key: 3
      }, [api_element("span", {
        classMap: {
        ...
        key: 2
      }, [api_text("("), api_dynamic($cmp.item.invmgrnp__Location__r.Name), api_text(")")])]), api_element("div", {
        classMap: {
          "slds-col": true,
          "slds-size_1-of-1": true,
        ...
        key: 4,
        on: {
          "click": _m0 || ($ctx._m0 = api_bind($cmp.handleIncrement))
        }
      }, []), api_custom_element("lightning-icon", _lightningIcon, {
        props: {
        ...
        key: 5,
        on: {
          "click": _m1 || ($ctx._m1 = api_bind($cmp.handleDecrement))
        }
      }, []), api_element("span", {
        classMap: {
        ...
        key: 7
      }, [api_text("Qty: "), api_element("input", {
        classMap: {
          "slds-input": true
        },
        styleMap: {
        ...
        props: {
          "value": $cmp.countChange
        },
        key: 8,
        on: {
          "keyup": _m2 || ($ctx._m2 = api_bind($cmp.handleKeyPress)),
          "blur": _m3 || ($ctx._m3 = api_bind($cmp.handleChange))
        }
      }, []), $cmp.showActionButtons ? api_custom_element("lightning-button", _lightningButton, {
        classMap: {
          "slds-m-left_xxx-small": true
        },
        props: {
          "label": "Add",
          "title": "Add"
        ...
        key: 9,
        on: {
          "click": _m4 || ($ctx._m4 = api_bind($cmp.handleAdd))
        }
      }, []) : null, $cmp.showActionButtons ? api_custom_element("lightning-button", _lightningButton, {
        props: {
          "label": "Remove",
          "title": "Remove"
        },
        key: 10,
        on: {
          "click": _m5 || ($ctx._m5 = api_bind($cmp.handleRemove))
        }
      }, []) : null, $cmp.showActionButtons ? api_custom_element("lightning-button", _lightningButton, {
        props: {
          "label": "Cancel",
        ...
        key: 11,
        on: {
          "click": _m6 || ($ctx._m6 = api_bind($cmp.handleCancel))
        }
      }, []) : null])])])])];
    }
    ...
    tmpl$6.stylesheetTokens = {
      hostAttribute: "lwc-item_item-host",
      shadowAttribute: "lwc-item_item"
    };
    ...
    var ITEM_Count_FIELD = {"fieldApiName":"Count__c","objectApiName":"Item__c"};

    var ITEM_ID_FIELD = {"fieldApiName":"Id","objectApiName":"Item__c"};

    var ITEM_ACTION_OBJECT = {"objectApiName":"Item_Action__c"};

    var Action_FIELD = {"fieldApiName":"Action__c","objectApiName":"Item_Action__c"};

    var Count_FIELD = {"fieldApiName":"Count__c","objectApiName":"Item_Action__c"};

    var Item_FIELD = {"fieldApiName":"Item__c","objectApiName":"Item_Action__c"};

    var Location_FIELD = {"fieldApiName":"Location__c","objectApiName":"Item_Action__c"};

    var User_FIELD = {"fieldApiName":"User__c","objectApiName":"Item_Action__c"};

    /* eslint-disable no-console */

    class Item extends lwc.LightningElement {
      constructor(...args) {
        super(...args);
        this.item = void 0;
        this.settings = void 0;
        this.key = void 0;
        this.apexrefreshcalled = void 0;
        this.showActionButtons = void 0;
        this.count = 0;
        this.countChange = 0;
        this.invmgrnp__Count__c_old = 0;
      }
      ...
      handleAdd() {
        ...
        let count = parseInt(this.template.querySelector('.itemQty').value, 0); //Only do a change if count has changed
        ...
        if (!isNaN(count) && count >= 0 && count !== this.count) {
          ...
          this.updateItem('Add', this.count, count, true); //reset text field
      ...
      handleRemove() {
        ...
        if (this.count - count >= 0) {
          ...
          //This is not needed for add as that should always be above 0
          this.count = this.count - count;
          this.updateItem('Remove', this.count, count, true); //reset text field
      ...
      updateItem(action, count, actualChange, showConfirmationMessage) {
        ...
        fields[ITEM_ID_FIELD.fieldApiName] = this.item.Id; //Use Lightning Data Service to update record as we are doing simple update

        const recordInput = {
          fields
        };
        updateRecord$2(recordInput).then(() => {
          ...
          this.showActionButtons = false; //Dispatch event for parent component to do refreshApex (or any other action) when item is updated
          // Creates the event with the contact ID data.

          const updateItemEvent = new CustomEvent('updateitemevent'); // Dispatches the event.
      ...
      updateItemAction(action, actualChange) {
        ...
        fields[User_FIELD.fieldApiName] = UserId; //Use Lightning Data Service to create record as we are doing simple insert

        const recordInput = {
          apiName: ITEM_ACTION_OBJECT.objectApiName,
          fields
        };
        createRecord$2(recordInput).then(itemAction => {
    ...
    lwc.registerDecorators(Item, {
      ...
      fields: ["showActionButtons", "count", "countChange", "invmgrnp__Count__c_old"]
    });

    var item = lwc.registerComponent(Item, {
      tmpl: _tmpl$7
    });
